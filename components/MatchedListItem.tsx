...
import { Heading, IconButton, useDisclosure, Modal, ModalOverlay, ModalContent, ModalCloseButton, ModalBody, Text, Divider, Avatar } from "@chakra-ui/react";
...
export default function MatchedListItem(props: ProfileSummaryBoxProps){
    ...
    return (
        <div style={{backgroundColor: props.color, padding: "10px", display: "flex", flexDirection: "row", border: "solid #E3E3E3", borderRadius: "5px"}}>
            ...
            <div style={{marginLeft: "auto", display: "flex", flexDirection: "row", marginRight: "10px"}}>
                <a style={{paddingRight: "15px", marginTop: "10px"}} target="_blank" rel="noreferrer" href={props.fbURL}>
                ...
                <a style={{paddingRight: "15px", marginTop: "10px"}} target="_blank" rel="noreferrer" href={props.igURL}>
                ...
                <a style={{paddingRight: "15px", marginTop: "10px"}} target="_blank" rel="noreferrer" href={props.scURL}>
                    <svg className="icon" fill="#414141" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 30 30" width="30px" height="30px">
